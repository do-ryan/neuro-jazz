...
class CNN(nn.Module):
    def __init__(self, batch_size):
        ...
        self.conv1 = nn.Conv2d(in_channels=1, out_channels=8, kernel_size=(k1[0],k1[1]), stride=k1).double()
        ...
        self.fc_inputsize = int(11520/batch_size) # size of fully connected input
